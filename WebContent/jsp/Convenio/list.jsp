...
<jsp:useBean id="controller" class="edu.fatec.controller.ConvenioController" />
<c:import url="/jsp/header.jsp" />

<h1 class="text-center col-sm-12">Lista de Convenios</h1>
...
<form class="form-group" action="${pageContext.request.contextPath}/ConvenioController" method="post">
