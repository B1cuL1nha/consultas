...
<jsp:useBean id="controller" class="edu.fatec.controller.ConsultaController" />
<c:import url="/jsp/header.jsp" />

<h1 class="text-center col-sm-12">Lista de Consultas</h1>
...
<form class="form-group" action="${pageContext.request.contextPath}/ConsultaController" method="post">
